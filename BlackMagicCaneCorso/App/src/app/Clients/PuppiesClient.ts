...
export class AnnouncementClient {
    ...
    addAnnouncement(announcementText: string | null | undefined): Observable<AnnouncementModel[]> {
        let url_ = this.baseUrl + "/Announcements/Add?";
        if (announcementText !== undefined)
            url_ += "announcementText=" + encodeURIComponent("" + announcementText) + "&"; 
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request("post", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processAddAnnouncement(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processAddAnnouncement(<any>response_);
                } catch (e) {
                    return <Observable<AnnouncementModel[]>><any>_observableThrow(e);
                }
            } else
                return <Observable<AnnouncementModel[]>><any>_observableThrow(response_);
        }));
    }

    protected processAddAnnouncement(response: HttpResponseBase): Observable<AnnouncementModel[]> {
        ...
        if (status === 200) {
            ...
            if (Array.isArray(resultData200)) {
                ...
                for (let item of resultData200)
                    result200!.push(AnnouncementModel.fromJS(item));
            }
        ...
        return _observableOf<AnnouncementModel[]>(<any>null);
    }

    updateAnnouncement(id: number | undefined, announcementText: string | null | undefined): Observable<AnnouncementModel[]> {
        let url_ = this.baseUrl + "/Announcements/Update?";
        if (id === null)
        ...
        return this.http.request("put", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processUpdateAnnouncement(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processUpdateAnnouncement(<any>response_);
                } catch (e) {
                    return <Observable<AnnouncementModel[]>><any>_observableThrow(e);
                }
            } else
    ...
    protected processUpdateAnnouncement(response: HttpResponseBase): Observable<AnnouncementModel[]> {
        const status = response.status;
        const responseBlob = 
            response instanceof HttpResponse ? response.body : 
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
    ...
    getAnnouncement(): Observable<AnnouncementModel[]> {
        let url_ = this.baseUrl + "/Announcements/Get";
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processGetAnnouncement(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processGetAnnouncement(<any>response_);
                } catch (e) {
                    return <Observable<AnnouncementModel[]>><any>_observableThrow(e);
                }
            } else
    ...
    protected processGetAnnouncement(response: HttpResponseBase): Observable<AnnouncementModel[]> {
        const status = response.status;
        const responseBlob = 
            response instanceof HttpResponse ? response.body : 
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
    ...
    deleteAnnouncement(id: number | undefined): Observable<AnnouncementModel[]> {
        ...
        return this.http.request("delete", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processDeleteAnnouncement(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processDeleteAnnouncement(<any>response_);
                } catch (e) {
                    return <Observable<AnnouncementModel[]>><any>_observableThrow(e);
                }
            } else
    ...
    protected processDeleteAnnouncement(response: HttpResponseBase): Observable<AnnouncementModel[]> {
        const status = response.status;
        const responseBlob = 
            response instanceof HttpResponse ? response.body : 
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
...
export class PictureClient {
    ...
    getImages(dogId: number): Observable<PictureInfo[]> {
        let url_ = this.baseUrl + "/Picture/Get/{dogId}";
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try {
                    ...
                    return <Observable<PictureInfo[]>><any>_observableThrow(e);
                }
            } else
                return <Observable<PictureInfo[]>><any>_observableThrow(response_);
        }));
    }

    protected processGetImages(response: HttpResponseBase): Observable<PictureInfo[]> {
        const status = response.status;
        const responseBlob = 
            response instanceof HttpResponse ? response.body : 
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
        ...
        return _observableOf<PictureInfo[]>(<any>null);
    }

    addImage(dogId: number | undefined, dogName: string | null | undefined): Observable<PictureInfo[]> {
    ...
    protected processAddImage(response: HttpResponseBase): Observable<PictureInfo[]> {
        const status = response.status;
        const responseBlob = 
            response instanceof HttpResponse ? response.body : 
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
    ...
    deleteImage(img: PictureInfo): Observable<PictureInfo[]> {
    ...
    protected processDeleteImage(response: HttpResponseBase): Observable<PictureInfo[]> {
        const status = response.status;
        const responseBlob = 
            response instanceof HttpResponse ? response.body : 
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
    ...
    setProfilePicture(dogId: number | undefined, imgId: number | undefined): Observable<PictureInfo[]> {
        let url_ = this.baseUrl + "/Picture/SetProfilePicture?";
        if (dogId === null)
            throw new Error("The parameter 'dogId' cannot be null.");
        else if (dogId !== undefined)
            url_ += "dogId=" + encodeURIComponent("" + dogId) + "&"; 
        if (imgId === null)
            throw new Error("The parameter 'imgId' cannot be null.");
        ...
        return this.http.request("put", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processSetProfilePicture(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processSetProfilePicture(<any>response_);
                } catch (e) {
                    return <Observable<PictureInfo[]>><any>_observableThrow(e);
                }
            } else
    ...
    protected processSetProfilePicture(response: HttpResponseBase): Observable<PictureInfo[]> {
        const status = response.status;
        const responseBlob = 
            response instanceof HttpResponse ? response.body : 
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
...
export class PuppiesClient {
    ...
    addPuppy(newDog: DogInfo): Observable<DogInfo[]> {
        ...
        return this.http.request("post", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try {
                    ...
                    return <Observable<DogInfo[]>><any>_observableThrow(e);
                }
            } else
                return <Observable<DogInfo[]>><any>_observableThrow(response_);
        }));
    }

    protected processAddPuppy(response: HttpResponseBase): Observable<DogInfo[]> {
        const status = response.status;
        const responseBlob = 
            response instanceof HttpResponse ? response.body : 
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
        ...
        return _observableOf<DogInfo[]>(<any>null);
    }

    updatePuppy(updateDog: DogInfo): Observable<DogInfo[]> {
    ...
    protected processUpdatePuppy(response: HttpResponseBase): Observable<DogInfo[]> {
        const status = response.status;
        const responseBlob = 
            response instanceof HttpResponse ? response.body : 
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
    ...
    deletePuppy(deleteDog: DogInfo): Observable<DogInfo[]> {
        let url_ = this.baseUrl + "/Puppies/Delete";
        url_ = url_.replace(/[?&]$/, "");

        const content_ = JSON.stringify(deleteDog);
        ...
        return this.http.request("delete", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processDeletePuppy(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processDeletePuppy(<any>response_);
                } catch (e) {
                    return <Observable<DogInfo[]>><any>_observableThrow(e);
                }
            } else
    ...
    protected processDeletePuppy(response: HttpResponseBase): Observable<DogInfo[]> {
        const status = response.status;
        const responseBlob = 
            response instanceof HttpResponse ? response.body : 
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
    ...
    protected processGet(response: HttpResponseBase): Observable<DogInfo[]> {
        const status = response.status;
        const responseBlob = 
            response instanceof HttpResponse ? response.body : 
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
    ...
    getByGender(gender: string | null | undefined): Observable<DogInfo[]> {
    ...
    protected processGetByGender(response: HttpResponseBase): Observable<DogInfo[]> {
        const status = response.status;
        const responseBlob = 
            response instanceof HttpResponse ? response.body : 
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
...
export class AnnouncementModel implements IAnnouncementModel {
    id!: number;
    announcementText!: string | undefined;

    constructor(data?: IAnnouncementModel) {
        if (data) {
    ...
    static fromJS(data: any): AnnouncementModel {
