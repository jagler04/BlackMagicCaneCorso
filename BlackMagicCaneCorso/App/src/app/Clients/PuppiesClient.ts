...
//     login(user: LoginModel): Observable<AuthModel | null> {
...
//                 } catch (e) {
//                     return <Observable<AuthModel | null>><any>_observableThrow(e);
//                 }
//             } else
//                 return <Observable<AuthModel | null>><any>_observableThrow(response_);
//         }));
//     }

//     protected processLogin(response: HttpResponseBase): Observable<AuthModel | null> {
...
//             }));
//         }
//         return _observableOf<AuthModel | null>(<any>null);
//     }
// }
...
//     addPuppy(newDog: DogInfo): Observable<DogInfo[] | null> {
...
//     updatePuppy(updateDog: DogInfo): Observable<DogInfo[] | null> {
...
//     deletePuppy(deleteDog: DogInfo): Observable<DogInfo[] | null> {
...
//     protected processDeletePuppy(response: HttpResponseBase): Observable<DogInfo[] | null> {
//         const status = response.status;
//         const responseBlob = 
//             response instanceof HttpResponse ? response.body : 
//             (<any>response).error instanceof Blob ? (<any>response).error : undefined;
